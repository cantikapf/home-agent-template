...
# 1. Update Indonesian README
with open(readme_id_path, 'r', encoding='utf-8') as f:
    readme_id = f.read()

header_id = "# 🏡 Home Agent (WhatsApp Personal Assistant)\n\n*Read this in [English](README-en.md)*\n"
if "*Read this in [English]*" not in readme_id:
    readme_id = readme_id.replace("# 🏡 Home Agent (WhatsApp Personal Assistant)\n", header_id)
    with open(readme_id_path, 'w', encoding='utf-8') as f:
        f.write(readme_id)

# 2. Create English README
readme_en = """# 🏡 Home Agent (WhatsApp Personal Assistant)
...
print("English README created and linked successfully!")
