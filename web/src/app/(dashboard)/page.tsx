...
import { 
  ...
  CheckCircle, AlertCircle, GitBranch, FileText, Settings, Wrench, Shield, ExternalLink
} from 'lucide-react';
...
function CustomTooltip({ active, payload, label }: any) {
  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--border)] rounded-sm p-2 text-xs dark:bg-zinc-900 bg-zinc-100 dark:border-zinc-700 border-[var(--border)]">
...
function StatCardSkeleton() {
  return (
    <div className="bg-[var(--card)] border border-[var(--border)] rounded-sm p-5 border-l-[3px] border-l-zinc-700 animate-pulse">
      <div className="flex items-start justify-between">
        ...
        <div className="w-11 h-11 rounded-sm bg-zinc-700" />
      </div>
    </div>
  );
}
  ...
  const fetchPlatforms = useCallback(async () => {
    try {
      ...
      if (res.ok) {
        ...
        if (data.routingInfo) {
          setRoutingInfo(data.routingInfo);
        }
      }
    } catch (e) { console.error(e); }
  }, []);
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-sm dark:bg-amber-500/10 bg-amber-50 dark:border-amber-500/20 border-amber-200 border dark:hover:bg-amber-500/20 hover:bg-amber-100 transition-all disabled:opacity-50"
        >
          <div className="w-9 h-9 rounded-sm border border-[var(--border)] bg-black/5 dark:bg-white/5 flex items-center justify-center flex-shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-sm dark:bg-red-500/10 bg-red-50 dark:border-red-500/20 border-red-200 border dark:hover:bg-red-500/20 hover:bg-red-100 transition-all disabled:opacity-50"
        >
          <div className="w-9 h-9 rounded-sm border border-[var(--border)] bg-black/5 dark:bg-white/5 flex items-center justify-center flex-shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-sm dark:bg-blue-500/10 bg-blue-50 dark:border-blue-500/20 border-blue-200 border dark:hover:bg-blue-500/20 hover:bg-blue-100 transition-all disabled:opacity-50"
        >
          <div className="w-9 h-9 rounded-sm border border-[var(--border)] bg-black/5 dark:bg-white/5 flex items-center justify-center flex-shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-sm dark:bg-white/5 bg-black/5 dark:border-[var(--border)] border-[var(--border)] border dark:hover:bg-zinc-800/50 hover:bg-zinc-100 transition-all"
        >
          <div className="w-9 h-9 rounded-sm border border-[var(--border)] bg-black/5 dark:bg-white/5 flex items-center justify-center flex-shrink-0">
      ...
      {/* Action Feedback */}
      {actionMessage && (
        <div className={`flex items-center gap-2 px-4 py-2.5 rounded-sm text-sm font-medium animate-fade-in ${
      ...
      <div className="bg-[var(--card)] border border-[var(--border)] rounded-sm p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {/* Services Status */}
          <div className="p-3 rounded-sm dark:bg-white/5 bg-black/5 border dark:border-[var(--border)] border-[var(--border)]">
            ...
            <div className="space-y-2.5">
              {health.loading ? (
                ...
                <>
                  {['Gateway', 'Dashboard', 'CF Tunnel', '9Router'].map((name) => (
                    <div key={name} className="flex items-center justify-between">
                      <span className="text-sm dark:text-zinc-300 text-zinc-700">{name}</span>
                      <div className="flex items-center gap-1.5">
                        <span className="w-2.5 h-2.5 rounded-full bg-black/50" />
      ...
      {stats && (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-sm p-5 animate-fade-in hover:border-indigo-500/20 transition-all duration-300">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                ...
                <div className={`w-11 h-11 rounded-sm bg-gradient-to-br ${gatewayOk ? 'from-emerald-500 to-green-500' : 'from-red-500 to-rose-500'} flex items-center justify-center`}>
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-sm p-5 animate-fade-in hover:border-indigo-500/20 transition-all duration-300">
              <div className="flex items-start justify-between">
                ...
                <div className="w-11 h-11 rounded-sm border border-[var(--border)] bg-black/5 dark:bg-white/5 flex items-center justify-center">
          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-sm p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <a href={process.env.NEXT_PUBLIC_NINEROUTER_URL || "http://localhost:20128"} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-3 py-1.5 rounded-sm dark:bg-indigo-500/10 bg-indigo-50 border dark:border-indigo-500/20 border-indigo-200 text-xs font-medium dark:text-indigo-400 text-indigo-600 hover:bg-indigo-500/20 transition-all">
                9Router Dashboard <ExternalLink className="w-3 h-3" />
              </a>
            </div>
            {routingInfo ? (
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 rounded-sm dark:bg-white/5 bg-black/5 border dark:border-[var(--border)] border-[var(--border)]">
                  <div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                      {routingInfo.auxiliary.map((aux: { role: string; provider: string; model: string }) => (
                        <div key={aux.role} className="p-2.5 rounded-sm dark:bg-white/5 bg-black/5 border dark:border-[var(--border)] border-[var(--border)]">
          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-sm p-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
              {platforms.map((platform) => (
                <div
                  key={platform.name}
                  className="group relative flex flex-col items-center gap-2 p-4 rounded-sm dark:bg-white/5 bg-black/5 border dark:border-[var(--border)] border-[var(--border)] transition-all hover:border-indigo-500/20"
                >
                  ...
                  {platform.enabled && (
                    <button
                      ...
                      className="absolute top-2 right-2 p-1.5 rounded-sm dark:bg-white/5 bg-zinc-100 border dark:border-[var(--border)] border-[var(--border)] opacity-0 group-hover:opacity-100 transition-all hover:bg-indigo-500/10 hover:border-indigo-500/30 disabled:opacity-100"
                  ...
                  <div className={`w-10 h-10 rounded-sm bg-gradient-to-br ${platform.color} flex items-center justify-center ${!platform.enabled ? 'opacity-20' : !platform.connected ? 'opacity-40' : ''}`}>
                    <platform.icon className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-sm font-medium dark:text-zinc-300 text-zinc-700">{platform.name}</span>
                  <div className="flex items-center gap-1.5">
                    <span className={`w-2 h-2 rounded-full ${platform.connected ? 'bg-emerald-400' : platform.enabled ? 'bg-amber-400' : 'bg-black/50'}`} />
